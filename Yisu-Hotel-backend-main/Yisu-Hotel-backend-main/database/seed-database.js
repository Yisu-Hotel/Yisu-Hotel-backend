...
async function seedUsers() {
  ...
  const users = await User.findOrCreate({
    ...
    defaults: {
      phone: '13800138000',
      password: '$2b$10$N9qo8uLOickgx2ZMRZoMyeIjZAgFLflJq9K6Y1uWdZjFM4I7Ci1C', // password123
      role: 'admin',
      nickname: '管理员',
      login_count: 10
    }
  ...
  await User.findOrCreate({
    ...
    defaults: {
      phone: '13800138001',
      password: '$2b$10$N9qo8uLOickgx2ZMRZoMyeIjZAgFLflJq9K6Y1uWdZjFM4I7Ci1C',
      role: 'merchant',
      nickname: '商户1',
      login_count: 5
    }
